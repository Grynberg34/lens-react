    ...
    return (
      ...
      <div className="studiolist__selection__list">
          ...
          { selection_list.filter.map( (item, index) =>
            ...
            <div key={index} className="studiolist__selection__list__item" style={{backgroundImage: `linear-gradient(to bottom, rgba(151,205,213, 0.9) 0%,rgba(151,205,213,0.9) 100%), url('https://image.tmdb.org/t/p/original/${item.poster_path}')`}}>
              <Container fluid>
                <Row>
                  <Col md={6}>
                  ...
                  <Col md={6}>
                    ...
                    <i className="studiolist__selection__list__item__icon flaticon-add-sign"></i>
